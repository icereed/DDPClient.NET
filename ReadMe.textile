*Stargazer.NET Alpha - A DDP Client for .NET*
...
*New features*
- Tested API: A unit test code coverage over 90% tries to get achieved.
- State tracking: You are able to track the state of the connection and you may act on certain events.
- More extensible architecture: It is tried to achieve an extensible architecture, so you can use components seperately or inject your own.
- A full documented API: There will be a documentation.
